...
public class Habadasher extends CustomVillager {
    ...
    public Entity spawn(Location location) {
        ...
        villager.customName(Component.text("Habadasher"));
        ...
        CustomVillager.addTrade(villager,
                ...
                null,
                DungeonItem.WATER_HAT.getItemStack());;
        CustomVillager.addTrade(villager,
                new ItemStack(Material.EMERALD, 40),
                null,
                DungeonItem.FIRE_HAT.getItemStack());
        CustomVillager.addTrade(villager,
                new ItemStack(Material.EMERALD, 40),
                null,
                DungeonItem.PROJECTILE_HAT.getItemStack());
        CustomVillager.addTrade(villager,
                new ItemStack(Material.EMERALD, 40),
                null,
                DungeonItem.BLAST_HAT.getItemStack());
        return villager;
    }
}
