...
public enum Pipe implements Bricks{
    ...
    P3HALL6 ("pipe/3hall6", 1, 5, 5, new Location(getWorld("Dungeon"), 0, -2, -2), false,
            new HashMap<>(Collections.singletonMap(
                    new Location(getWorld("Dungeon"), 1, 0, 0), Region.PIPE3)),
            new ArrayList<>(Collections.singletonList(
                    new DungeonEntity(new Location(DungeonManager.world, 0.5, 0, 0.5), DungeonMob.COMMON_DROWNED, 7000)
            ))),
    ...
    P3CROSS1 ("pipe/3cross1", 5, 5, 4, new Location(getWorld("Dungeon"), 0, -2, -2), true,
            new HashMap<>(Map.of(
                    ...
                    new Location(getWorld("Dungeon"), 2, 0, -3, 270, 0), Region.PIPE3)),
            new ArrayList<>()),
    P3CROSS2 ("pipe/3cross2", 7, 10, 7, new Location(getWorld("Dungeon"), 0, -6, -3), true,
            new HashMap<>(Map.of(
            ...
            new ArrayList<>(Arrays.asList(
                    new DungeonEntity(new Location(DungeonManager.world, 3.5, -3, 0.5), DungeonMob.COMMON_DROWNED, 7000),
                    new DungeonEntity(new Location(DungeonManager.world, 3.5, -3, 0.5), DungeonMob.COMMON_DROWNED, 8000)
            ))),
